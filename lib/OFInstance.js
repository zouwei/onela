    ...
    var factory = {
        "MYSQL": function () {
            return new Promise(function (resolve, reject) {
                ...
                console.log('执行queryWaterfallList参数：', JSON.stringify(p || {}));
                //瀑布流数据查询（单次数据查询）
    ...
    var factory = {
        "MYSQL": function () {
            return new Promise(function (resolve, reject) {
                 ...
                 */
                var p = oParameters.getParameters(paras);
                console.log('执行queryEntityList参数：', JSON.stringify(p || {}));
                //变量定义
                var result = {
                    "data": [],                                         //数据列表
    ...
    var factory = {
        "MYSQL": function () {
            return new Promise(function (resolve, reject) {
                 ...
                 */
                var p = oParameters.getParameters(paras);
                console.log('执行queryEntity参数：', JSON.stringify(p || {}));
                //瀑布流数据查询（单次数据查询）
                var sql = "select  " + p["select"] + " from " + paras.command.tableName + " as t " + p.where + p.orderBy + p.limit + ";";
                /**
                 * 执行SQL
    ...
    var factory = {
        "MYSQL": function () {
            return new Promise(function (resolve, reject) {
                 ...
                 */
                var p = oParameters.getParameters(paras);
                console.log('执行statsByAggregate参数：', JSON.stringify(p || {}));
                /**
                 * 参数比对，符合条件的参数才执行处理
                 * 其他聚合函数（SQL）根据需要再添加
                 */
    ...
    var factory = {
        "MYSQL": function () {
            return new Promise(function (resolve, reject) {
                ...
                var _error = false;
                var error = [];
                console.log('参数', paras.config.parameter)
