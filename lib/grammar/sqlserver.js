        ...
        if (paras.update[i].hasOwnProperty('case_field')) {
            ...
            for (let cw in item.case_item) {
                ...
                switch (oper) {
                    case 'replace':
                         ...
                         */
                        case_str.push("WHEN @" + item.case_field + "_before_" + cw + " THEN @" + item.case_field + "_after_" + cw);
                        _self.parameters.push({
                            "name": item.case_field + "_before_" + cw,
                            "sqlType": m.sqlTypeHandle(paras.update[i].sqlType),
                            "value": item.case_item[cw].case_value
                        });
                        _self.parameters.push({
                            "name":  item.case_field + "_after_" + cw,
                            "sqlType": m.sqlTypeHandle(paras.update[i].sqlType),
                    ...
                    case "plus":
                         ...
                         * 值累加
                         */
                        case_str.push("WHEN @" + item.case_field + "_before_" + cw + " THEN " + item.case_field + " + @" + item.case_field + "_after_" + cw);
                        _self.parameters.push({
                            "name": item.case_field + "_before_" + cw,
                            "sqlType": m.sqlTypeHandle(paras.update[i].sqlType),
                            "value": item.case_item[cw].case_value
            ...
            switch (oper) {
                ...
                case "plus":
                     ...
                     * 值累加
                     */
                    _self.set.push(paras.update[i].key + '=' + paras.update[i].key + "+ @" + paras.update[i].key);
                    //_self.parameters.push(paras.update[i].value);
                    _self.parameters.push({
                        "name": paras.update[i].key,
                        "sqlType": m.sqlTypeHandle(paras.update[i].sqlType),
