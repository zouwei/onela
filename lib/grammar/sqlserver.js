...
m.getUpdateParameters = function (paras) {
    ...
    for (let i in paras.update) {
        ...
        // 字段验证
        for (let s = 0; s < paras.configs.fields.length; s++) {
            if (paras.update[i].case_field === paras.configs.fields[s].name) {
            ...
            for (let cw in item.case_item) {
                ...
                switch (oper) {
                    case 'replace':
                         ...
                         */
                        case_str.push("WHEN @" + item.case_field + "_p_" + cw + " THEN @" + item.case_field + "_l_" + cw);
                    ...
                    case "plus":
                         ...
                         * 值累加
                         */
                        case_str.push("WHEN @" + item.case_field + "_p_" + cw + " THEN " + item.case_field + " + @" + item.case_field + "_l_" + cw);
