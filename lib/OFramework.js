...
function proc(_config) {
    ...
    if (!(this instanceof Proc)) {
        return new Proc(_config);
    }
}

function Tools(_config) {
    //初始化配置
...
Service.prototype.getEntityList = function (paras) {
    ...
    var promise = new Promise(function (resolve, reject) {
        m.getEntityList(databaseConfig, instanceConfig, paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
...
Service.prototype.getEntityListByWaterfall = function (paras) {
    ...
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        m.getEntityListByWaterfall(databaseConfig, instanceConfig, paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
...
Service.prototype.getEntity = function (paras) {
    ...
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        m.getEntity(databaseConfig, instanceConfig, paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
...
Service.prototype.insertEntity = function (paras) {
    ...
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        m.insertEntity(databaseConfig, instanceConfig, paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
...
Service.prototype.insertBatch = function (paras) {
    ...
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        m.insertBatch(databaseConfig, instanceConfig, paras).then(function (result) {
            resolve(result);
        }, function (err) {
            reject(err);
        });
...
Service.prototype.updateBySenior = function (paras) {
    ...
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        m.updateBySenior(databaseConfig, instanceConfig, paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
    ...
    var promise = new Promise(function (resolve, reject) {
        ...
        async.whilst(
            ...
            function (callback) {
                 ...
                 * 更新
                 */
                m.updateBySenior(databaseConfig, instanceConfig, data[index]).then(function (result) {
                    //更新索引
                    index++;
...
Service.prototype.getEntityByAggregate = function (paras) {
    ...
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        m.getEntityByAggregate(databaseConfig, instanceConfig, paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
...
Service.prototype.deleteEntity = function (paras) {
    ...
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        m.deleteEntity(databaseConfig, instanceConfig, paras).then(function (result) {
            resolve(result);
        }, function (err) {
            reject(err);
        });
...
Proc.prototype.call = function (proc_name, paras) {
    ...
    var promise = new Promise(function (resolve, reject) {
         ...
         * 执行存储过程
         */
        ofInstance(databaseConfig, _instance).call(paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
 ...
 * @param paras
 */
t.getConfigFields = function (databaseConfig, instanceConfig) {
    //
    var promise = new Promise(function (resolve, reject) {
        /**
        ...
        //执行数据请求
        m.getEntityListByWaterfall(databaseConfig, instanceConfig, condition).then(function (data) {
            console.log(data);
            if (data.length == 0) {
 ...
 * 获取表名称列表
 */
t.findTableNames = function (_config) {
    _config = _config || {};
    //参数
 ...
 * 循环遍历表列表
 */
t.loop = function (fieldConfig, list) {
    //配置结果参数
    var promise = new Promise(function (resolve, reject) {
        ...
        async.whilst(
            ...
            function (callback) {
                ...
                t.getConfigFields(databaseConfig, instanceConfig).then(function (data) {
                    //更新索引
                    index++;
                    /**
                     * 如果表内部没有数据怎么办？暂时不处理
 ...
 * 自动化更新
 */
Tools.prototype.initConfigFile = function (_config) {
    /**
     * 1.读取文件，没有文件就创建文件
     * 2.查询数据库表名称列表
     * 3.遍历数据列表，请求表内第一条数据
    ...
    var promise = new Promise(function (resolve, reject) {
        ...
        //文件是否存在
        read(paras.file).then(function (data) {
            //读取到了配置文件
            fieldConfig = data;
            //读取数据库名称列表
            return t.findTableNames(_config);
             ...
             */
            console.log('开始写入文件');
            var writeStream = fs.createWriteStream(paras.file);
 ...
 * **********************************************************************************************************
 */
m.getEntityList = function (databaseConfig, instanceConfig, paras) {
//定义结构
    var promise = new Promise(function (resolve, reject) {
        /**
         * 定义SQL命令参数
         ...
         * 对应结果直接返回
         */
        ofInstance(databaseConfig, _instance).queryEntityList(paras).then(function (data) {
            //返回结构
            resolve(data);
        }, function (err) {
            reject(err);
 ...
 * @returns {Promise}
 */
m.getEntityListByWaterfall = function (databaseConfig, instanceConfig, paras) {
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        /**
         * 定义SQL命令参数
         ...
         * 对应结果直接返回
         */
        ofInstance(databaseConfig, _instance).queryWaterfallList(paras).then(function (data) {
            /**
             * 获取到了分页数据
             * 检测是否为最后一页数据
             * 查询结果行数删除末尾一条数据
 ...
 * 主要是底层数据方法
 */
m.getEntity = function (databaseConfig, instanceConfig, paras) {
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        /**
         * 定义SQL命令参数
         ...
         * ORM底层实例
         */
        ofInstance(databaseConfig, _instance).queryEntity(paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
 ...
 * @param paras
 */
m.insertEntity = function (databaseConfig, instanceConfig, paras) {
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        /**
         * ：：以下代码重用时不需要更改，特殊情况除外
        ...
        m.getID('A', null, function (id) {
             ...
             */
            ofInstance(databaseConfig, _instance).insertion(p).then(function (data) {
                resolve(data);
            }, function (err) {
                reject(err);
            });
 ...
 * @param paras
 */
m.insertBatch = function (databaseConfig, instanceConfig, paras) {
    ...
    var promise = new Promise(function (resolve, reject) {
         ...
         * 执行SQL，底层方法通用，配置好了参数集合列表底层自动完成
         */
        ofInstance(databaseConfig, _instance).insertionBatch(p).then(function (result) {
            resolve(result);
        }, function (err) {
            reject(err);
        });
 ...
 * @param paras
 */
m.updateBySenior = function (databaseConfig, instanceConfig, paras) {
    //定义结构
    var promise = new Promise(function (resolve, reject) {
        /**
         * 定义SQL命令参数
         ...
         * 执行sql
         */
        ofInstance(databaseConfig, _instance).updateBySenior(p).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
 ...
 * @param paras
 */
m.getEntityByAggregate = function (databaseConfig, instanceConfig, paras) {
//定义结构
    var promise = new Promise(function (resolve, reject) {
        /**
         * 条件判断
         ...
         * 对应结果直接返回
         */
        ofInstance(databaseConfig, _instance).statsByAggregate(paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
 ...
 * @param paras
 */
m.deleteEntity = function (databaseConfig, instanceConfig, paras) {
//定义结构
    var promise = new Promise(function (resolve, reject) {
        /**
         * 定义SQL命令参数
         ...
         * 物理删除，根据
         */
        ofInstance(databaseConfig, _instance).deleteEntity(paras).then(function (data) {
            resolve(data);
        }, function (err) {
            reject(err);
        });
