        ...
        return new Promise((resolve, reject) => {
                if (self.conn) {
                    ...
                    request.on('doneProc', function (r, m, status) {
                        ...
                        console.log("doneProc",rows.length, rows);
                    });
...
// 执行带事务的实例对象
    static
    executeTransaction(sql, parameters, transaction) {
    ...
    static
    queryEntity(params, option = {"transaction": null}) {
        let self = this;
    ...
    static
    queryEntityList(params, option = {"transaction": null}) {
        let self = this;
        let p = GrammarParameter.getParameters(params);
        //变量定义
        let result = {
    ...
    static
    insert(params, option = {"transaction": null}) {
        let p = [], f = [], s = [];
        console.log('进入了。。。。');
    ...
    static
    insertBatch(params, option = {"transaction": null}) {
        let p = [], f = [], s = [];
        for (let i in params.insertion) {
            let s2 = [];
    ...
    static
    deleteEntity(params, option = {"transaction": null}) {
    ...
    static
    updateEntity(params, option = {"transaction": null}) {
    ...
    static
    statsByAggregate(params, option = {"transaction": null}) {
        let p = GrammarParameter.getParameters(params);
        let check = {
            "count": "COUNT",
            "sum": "SUM",
