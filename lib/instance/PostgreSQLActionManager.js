...
// 语法处理
const GrammarPostgresql = require("../grammar/postgresql.js");
/**
 * PostgreSQL
...
class PostgreSQLActionManager extends BaseActionManager {
    ...
    static queryEntity(params, option = {"transaction": null}) {
        let self = this;
        let p = GrammarPostgresql.getParameters(params);
    ...
    static deleteEntity(params, option = {"transaction": null}) {
        ...
        let p = GrammarPostgresql.getDeleteParameters(params);
    ...
    static updateEntity(params, option = {"transaction": null}) {
        let p = GrammarPostgresql.getUpdateParameters(params);
        let _limit = "";
